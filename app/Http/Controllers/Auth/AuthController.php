...
class AuthController extends Controller
{
     ...
     *      @OA\Response(response=400, description="request not Found"),
     ...
     *          @OA\JsonContent(
     *              type="object",
     *              @OA\Property(property="name", type="string", example="Yudita"),
     *              @OA\Property(property="email", type="string", example="yudita@gmail.com"),
     *              @OA\Property(property="password", type="string", example="123456"),
     *              @OA\Property(property="password_confirmation", type="string", example="123456")
     *          ),
     *      ),
     *      @OA\Response(response=200, description="Pendaftaran User Baru" ),
     *      @OA\Response(response=400, description="request Not found"),
     ...
     *     security={{"bearer":{}}},
     *     @OA\Response(response=200, description="Autetikasi User" ),
